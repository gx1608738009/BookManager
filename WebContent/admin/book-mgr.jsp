    ...
    <div id="container">
    	...
    	<div class="menu">
    		<ul>
    			...
    			<li><a href="QueryCategoryController">图书分类管理</a></li>
				...
				<table class="table" cellspacing="0" style="font-size: 12px;">
			    	...
			    	<c:forEach items="${pg.pageLists }" var="b">
			    		<tr>
				    		...
				    		<td><a href="${pageContext.request.contextPath}/BookInfoController?op=delete&id=${b.id}">删除</a>&nbsp;
				    		<a href="book-edit.jsp">编辑</a></td>
				    	</tr>
			    	</c:forEach>
			    </table>
			    <div class="paging">
   					 <span class="fr"><a href="${pageContext.request.contextPath}/Book?pageIndex=1">首页</a>&nbsp;
   					 <a href="${pageContext.request.contextPath}/Book?pageIndex=${pg.currPage-1}">上一页</a>&nbsp;
   					 <a href="${pageContext.request.contextPath}/Book?pageIndex=${pg.currPage+1}">下一页</a>&nbsp;
   					 <a href="${pageContext.request.contextPath}/Bookr?pageIndex=${pg.totalPages}">尾页</a>&nbsp;
   					 </span>    					
   				</div>
			</div>
			<div class="section-right">
				<h2>添加图书信息</h2>
				<form action="${pageContext.request.contextPath}/BookInfoController?op=add" method="post">
